            ...
            var t = this.each(function() {
                ...
                if (e.is("select")) {
                    ...
                    if (t) {
                        ...
                        n.  = F.extend({}, c.DEFAULTS. , F.fn.selectpicker.defaults ? F.fn.selectpicker.defaults.  : {}, e.data(). , i. ), e.data("selectpicker", t = new c(this, n))
                    }
